...
- chat_api - Code for the application's Lambda function.
...
The SAM CLI installs dependencies defined in `chat_api/requirements.txt`, creates a deployment package, and saves it in the `.aws-sam/build` folder.
